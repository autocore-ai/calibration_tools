# Install script for directory: /home/jian/licalib_ws/src/lidar_IMU_calib/thirdparty/Pangolin/tools/VideoJson
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/jian/licalib_ws/src/lidar_IMU_calib/thirdparty/build-pangolin/tools/VideoJson/VideoJsonPrint")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/VideoJsonPrint" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/VideoJsonPrint")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/VideoJsonPrint"
         OLD_RPATH "/home/jian/licalib_ws/src/lidar_IMU_calib/thirdparty/build-pangolin/src:"
         NEW_RPATH "")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/jian/licalib_ws/src/lidar_IMU_calib/thirdparty/build-pangolin/tools/VideoJson/VideoJsonTransform")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/VideoJsonTransform" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/VideoJsonTransform")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/VideoJsonTransform"
